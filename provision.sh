...
sudo apt-get -y install php5.6 php5.6-cli php5.6-common php5.6-curl php5.6-dev php5.6-fpm php5.6-json php5.6-mbstring php5.6-mcrypt php5.6-mysql php5.6-opcache libapache2-mod-php5.6
