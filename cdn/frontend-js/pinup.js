...
directory = {
    ...
    paths: {
        ...
        gateway: 'http://pinup.justinbull.dev/gateway/',
        cdn: 'http://pinup.justinbull.dev/cdn/',
        website: 'http://pinup.justinbull.dev/'
    }
};
    ...
    */
    ...
    confirmPrompt: {
        ...
        childNodes: [
            ...
            commonHTML.buildButton("YES I DO", {
                "class": classes.promptAccept
            }),
            commonHTML.buildButton("NO THANKS", {
                "class": classes.promptDeny
            })
        ]
    }
...
PinUi.prototype = {
    ...
    init: function() {
        ...
        var ui = this,
            guiLeftHolder = plib.domAppend(html.div, ui.scope.privateElements.imgOverlay, {
                'class': classes.guiLeftHolder
            }),
            guiRightHolder = plib.domAppend(html.div, ui.scope.privateElements.imgOverlay, {
                'class': classes.guiRightHolder
            }),
            btnCancel = plib.domAppend(html.span, guiRightHolder, {
                'class': classes.guiTopR + whiteSpace + classes.btnCancel
            });
    ...
    ownerInit: function() {
        ...
        var ui = this,
            btnSettings = plib.domAppend(html.span, ui.scope.privateElements.imgOverlay, {
                'class': classes.btnSettings
            });
    ...
    build: function() {
        ...
        plib.loopArray(ui.leftNavItems, function(value) {
            ...
            if (value.isPrivate && !ui.allowPrivateInterfaces) {
                return;
            }
...
PinInst.prototype = {
    ...
    positionHelper: function() {
        ...
        ***/
        ...
        var pInst = this,
            ...
            posMethod = (positionType === 'absolute') ? {
                top: css.top,
                left: css.left
            } : {
                top: css.margin.top,
    ...
    updateNode: function(forceRedraw, forceReload) {
        ...
        if (pInst.updateInProgress === true) {
            return;
        }
        ...
        if (plib.hasProperty(cacheTagData, pInst.imageSrc)) {
            ...
            if (queueTagData[pInst.uid].length > 1) {
                return;
            }

            // GET TAG DATA FROM SERVER
            plib.loadJSONP(directory.names.getTags, {
                'strImageURL': pInst.imageSrc
            }, function(data) {
...
pfunc = {
    ...
    systemStart: function() {
        ...
        while (document.body.firstChild) {
            globalElements.pInstActive.appendChild(document.body.firstChild);
        }
        ...
        globalElements.pInstWrapper = plib.domAppend(html.div, globalElements.pInstActive, {
        ...
        // CREATE WINDOW HTML
        globalElements.pInstWindow = plib.domAppend(html.div, globalElements.pInstWrapper, {
            'class': classes.window
        });
        globalElements.pInstWindowOverlay = plib.domAppend(html.div, globalElements.pInstWrapper, {
            'class': classes.windowOverlay
        });
        globalElements.pInstWindowClose = plib.domAppend(html.span, globalElements.pInstWindow, {
            'class': classes.windowClose
        }, 'close');
        globalElements.pInstWindowBody = plib.domAppend(html.div, globalElements.pInstWindow, {
            'class': classes.windowBody
        });
        globalElements.pInstWindowBackground = plib.domAppend(html.div, globalElements.pInstWindow, {
            'class': classes.windowBackground
        });
    ...
    */
    mergeStrictObjects: function(masterObject, slaveObject) {
        ...
        plib.loopObject(slaveObject, function(key, val) {
            ...
            // {opendebug}
            if (!plib.hasProperty(masterObject, key)) {
                pfunc.warn(messages.settingDNF, key);
            }
            // {closedebug}
    ...
    openWindow: function(layObject, callback) {
        ...
        */
        ...
        if (callback) {
            callback.call(globalElements.pInstWindow);
        }
    ...
    */
    ...
    manageTagSuggestionList: function(form) {
        ...
        var dropdown = plib.domAppend(html.div, form, {
                'class': classes.formDropDownDiv
            }),
    ...
    promptOpenLightbox: function(image) {
        ...
        var lightbox,
            ...
            destroyLightbox = function() {
                ...
                plib.loopArray(nodeTracker, function(node) {
                    if (node) {
        ...
        if (!plib.isObjectEmpty(cacheImages)) {
            ...
            lightbox = plib.domAppend(html.div, globalElements.pInstActive, {
                'class': classes.lightbox
            });
            lightboxOverlay = plib.domAppend(html.div, lightbox, {
                'class': classes.lightboxOverlay
            });
            lightboxWindow = plib.domAppend(html.div, lightbox, {
                'class': classes.lightboxWindow
            });
            lightboxImageHolder = plib.domAppend(html.div, lightboxWindow, {
                'class': classes.lightboxImageHolder
            });
            lightboxShowLeft = plib.domAppend(html.div, lightboxWindow, {
                'class': classes.lightboxNav + whiteSpace + classes.lightboxShowLeft
            });
            lightboxShowRight = plib.domAppend(html.div, lightboxWindow, {
                'class': classes.lightboxNav + whiteSpace + classes.lightboxShowRight
            });

            // insert some icons into our nav buttons
            plib.domAppend(html.span, lightboxShowLeft, {
                'class': classes.lightboxNavIcon
            });
            plib.domAppend(html.span, lightboxShowRight, {
                'class': classes.lightboxNavIcon
            });
            ...
            plib.loopObject(cacheImages, function(key, val) {
                ...
                if (val.loaded && val.image.src !== window.location.href) {
                    plib.domAppend(html.img, lightboxImageHolder, {
                        'class': classes.lightboxImage,
                        'src': val.image.src
                    });
                    i += 1;
                }
...
function Pinup(publicKey, sysParams) {
    ...
    plib.onDomReady(function() {
        ...
        if (!exist) {
            ...
            // set the public key
            if (publicKey) {
                globalVars.publicKey = publicKey;
            }
